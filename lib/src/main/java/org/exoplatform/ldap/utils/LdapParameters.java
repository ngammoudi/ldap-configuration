...
/**
 * Created by nagui on 12/03/15.
 */
public class LdapParameters {
    public static final String LDAP_CONF_AUTH="exo.ldap.auth.enabled";
    public static final String LDAP_CONF_TYPE="exo.ldap.type";
    public static final String LDAP_CONF_URL="exo.ldap.url";
    public static final String LDAP_CONF_AUTH_TYPE="exo.ldap.authentication";
    public static final String LDAP_CONF_ADMIN_DN="exo.ldap.admin.dn";
    public static final String LDAP_CONF_ADMIN_DN_PWD="exo.ldap.admin.password";
    public static final String LDAP_CONF_POOL="exo.ldap.connection.pool";
    public static final String LDAP_CONF_MAX_POOL="exo.ldap.connection.pool.maxsize";
    public static final String LDAP_CONF_POOL_TIMEOUT="exo.ldap.connection.pool.timeout";
    public static final String LDAP_CONF_PROTOCOL="exo.ldap.connection.pool.protocol";
    public static final String LDAP_CONF_READ_ONLY="exo.ldap.readonly";
    ...
    public static final String LDAP_CONF_GROUPS_SEARCH_SCOPE="exo.ldap.groups.search.scope";
    public static final String LDAP_CONF_FILE="exo.ldap.config.file";
